...
public class InputController {
	...
	/**
	 * CUANDO LE DEMOS AL BOTON DE GUARDAR SE ACTIVARA ESTA ACCION
	 * LA CUAL PERMITE GUARDAR EL RESULTADO 
	 * @param event
	 */
	@FXML
	...
	/**
	 * METODO QUE MUESTRA EL FRAME SEL INPUT (ENTRADA)
	 * @param mensaje
	 */
	...
	public void setLabelText(String mensaje) {
		lblMensaje.setText(mensaje);//PARA GUARDAR EL MENSAJE
	}
}
