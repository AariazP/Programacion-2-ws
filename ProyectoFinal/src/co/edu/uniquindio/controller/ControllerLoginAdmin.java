...
public class ControllerLoginAdmin {
	...
	/**
	 * METODO QUE INICIA LA SECION DE UN ADMIN DADO SU CONTRASEÑA Y SU USUARIO
	 * EL CUAL ESOS DATOS DEBEN CONSIDIR CON LOS QUE SE REGISTRARON
	 * @param e
	 */
	public void iniciarSesion(ActionEvent e) {
		//EL CAMPO DE TEXTO DE CONTRASEÑA Y USUARION DEBEN DE SER DIFERENTES A ISEMPTY Y TAMBIEN 
		//CUANDO VERIFIQUEMOS LA CONTRASEÑA Y USUARIO QUE SEAN CORRECTOS, ENTRAN AL PANEL DEL ADMIN
