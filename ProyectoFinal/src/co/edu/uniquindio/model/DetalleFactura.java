...
public class DetalleFactura {
	...
	//-----------MÉTODOS-----------
	/**
	 * MÉTODO QUE COMPARA EL NOMBRE DEL DETALLE CON EL NOMBRE DEL 
	 * PRODUCTO PASADO COMO PARAMETRO
	 * @param prodAux
	 * @return
	 */
	public boolean compararProducto(Producto prodAux) {
		//VERIFICO EL NOMBRE
		if(prodAux.getNombre().equals(nombre))return true; 
		return false;
	}
